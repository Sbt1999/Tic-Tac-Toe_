...
public class App {
    ...
    public static void main(String[] args) throws DuplicateSymbolException, PlayersCountMismatchException,
        ...
        playerList.add(new Player('X', "Shobhit", 1, PlayerType.HUMAN));
